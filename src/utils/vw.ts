...
const pxScale = (deviceVwSize: number, windowWidth: number) => (width: number): number => {
...
export const pxDesktop = (width: number, windowWidth: number) => pxScale(config.stage.desktop, windowWidth)(width);
export const pxTablet = (width: number, windowWidth: number) => pxScale(config.stage.tablet, windowWidth)(width);
export const pxMobile = (width: number, windowWidth: number) => pxScale(config.stage.mobile, windowWidth)(width);
